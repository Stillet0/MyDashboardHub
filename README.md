...
- [x] Recherche globale — barre de recherche dans l'en-tête qui retrouve instantanément une tâche, un événement, une habitude, un véhicule/échéance/entretien, un document, un rendez-vous/traitement santé, un objectif, un voyage ou une note (titre, tags et contenu), et navigue directement vers le bon module
...
L'onglet "Aperçu" (ancien "Aujourd'hui") sert de page d'accueil : une grille de tuiles résume chaque module (Finances, Agenda, Tâches, Santé, Objectifs, Habitudes, Voiture, Documents, Voyages, Notes) — clique sur une tuile pour aller directement au module concerné.
